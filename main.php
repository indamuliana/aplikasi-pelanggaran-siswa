...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Sistem Pembinaan Karakter</title>
    <script language="JavaScript">
      var txt=":: Sistem Pembinaan Karakter";
    ...
    <link rel="shortcut icon" href="images/favwikrama.ico">
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="main.php?module=home" class="site_title">
                <div class="logo_pic"><img src="images/logo wikrama.png" alt="..." width="50" height="50"></div>
                <span><h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SIPAKAR</h4></span>
                <span><h5>&nbsp;&nbsp;&nbsp;SMK WIKRAMA</h5></span></a>
            </div>
        ...
        }elseif ($_GET['module'] == 'detail_siswaa') {
                include "module/siswa/detail_siswaa.php";
        }elseif ($_GET['module'] == 'detail_siswa1') {
                include "module/siswa/detail_siswa1.php";
        }elseif ($_GET['module'] == 'detail_siswa2') {
                include "module/siswa/detail_siswa2.php";
        }elseif ($_GET['module'] == 'profil_siswa') {
                include "module/siswa/profil_siswa.php";
        }
         elseif ($_GET['module'] == 'rayon') {
                include "module/rayon/tampil_rayon.php";
        }elseif ($_GET['module'] == 'tambah_rayon') {
                include "module/rayon/form_tambah.php";
        }elseif ($_GET['module'] == 'edit_rayon') {
                include "module/rayon/form_edit.php";
        }
        ...
        }elseif ($_GET['module'] == 'detail_pelanggaran') {
                include "module/laporan_pelanggaran/tampil_detail1.php";
        ...
        }elseif ($_GET['module'] == 'detail_prestasi') {
                include "module/laporan_prestasi/tampil_detail1.php";
        ...
        <footer>
          <div class="pull-right" style="text-align: center;">
            Sistem Pembinaan Karakter Siswa-SMK WIKRAMA 1 GARUT &copy;2019
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script>
      $(document).ready(function() {
        ...
        include "lib/koneksi.php";
        //get matched data from skills table
        $query = $connect->query("SELECT * FROM rayon");
        ?>

        var rayon ={
          <?php while($row=mysqli_fetch_array($query)){
            echo "$row[id_rayon]".":\""."$row[id_rayon]"." - "."$row[nama_rayon]"."\",";
          } ?>
        };

        var rayonArray = $.map(rayon, function(value, key) {
          return {
            value: value,
            data: key
          };
        ...
        // initialize autocomplete with custom appendTo
        $('#autocomplete-rayon').autocomplete({
          lookup: rayonArray,
          appendTo: '#autocomplete-container'
        });
      });
    ...
    <!-- Select Kategori & Sub Kategori -->
        ...
        <!-- Select rayon & Ortu -->
    <script language='javascript'>
      function tampilDafOrtu()
      {
      <?php
        // membaca semua rayon
        $proses = mysqli_query($connect,"SELECT * FROM rayon ORDER BY id_rayon ASC");

        // membuat if untuk masing-masing pilihan rayon beserta isi option untuk combobox kedua
        while ($database = mysqli_fetch_array($proses))
        {
          $ray = $database['id_rayon'];

          // membuat IF untuk masing-masing rayon
          echo "if (document.getElementById(\"tambah_siswa\").namaRayon.value == \"".$ray."\")";
          echo "{";

          // membuat option daftar Ortu untuk masing-masing ortu
          $proses2 = mysqli_query($connect,"SELECT * FROM orang_tua WHERE id_rayon = '$ray' ORDER BY id_ortu ASC");
          $contentt = "document.getElementById('namaOrtu').innerHTML = \"";
          while ($database2 = mysqli_fetch_array($proses2))
          {
            $contentt .= "<option value='".$database2['id_ortu']."'>".$database2['nama_ortu']."</option>";
          }
